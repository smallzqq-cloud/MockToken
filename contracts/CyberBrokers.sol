...
contract CyberBrokers is ERC721Burnable, Ownable
{
	...
	{
		// Set the addresses //address(new CyberBrokersMetadata(address(new ContractDataStorage(), address(new SvgParser()))))
		setCyberBrokersMetadataAddress(address(new CyberBrokersMetadata(address(new ContractDataStorage()),address(new SvgParser()))));
