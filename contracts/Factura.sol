    ...
    Ownable
{
    ...
    ) ERC721ACommon(msg.sender,msg.sender,"Factura by Mathias Isaksen", "FACTURA",payable(msg.sender),0) {
        _signersEarlyAccess.add(signerEarlyAccess);
        _signersPublic.add(signerPublic);
        _baseTokenURI = baseTokenURI;
        mintConfig = config;

        paymentSplitter = payable(0xAe6f843377e67c6D1a4999Fa6F7eAA68940eF005);

        paymentSplitterRoyalties = payable(0xAe6f843377e67c6D1a4999Fa6F7eAA68940eF005);
