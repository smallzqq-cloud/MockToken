...
import "./others/chainLink/VRFConsumerBaseV2.sol";
  ...
  VRFConsumerBaseV2
{
    ...
    VRFConsumerBaseV2(vrfCoordinator_)
  {
    ...
    numberOfCommunities = 21;
    maxCommunityWhitelistLength = 150;
    whitelistMintStart = 1659978000;
    pauseCutoffDays = 90;
  ...
  function min(address to, uint256 tokenId) public {
